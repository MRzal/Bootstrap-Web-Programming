								...
								<label>Siswa</label>
									<div class="input-group">
										...
										<?php
											...
											$querynilaimhs = mysqli_query($konek, "SELECT NIM_Nilai, NIM, Nama_Mahasiswa FROM nilai INNER JOIN Siswa ON NIM_Nilai=NIM WHERE Id_Nilai='$Id_Nilai'");
								...
								<label>Matapelajaran</label>
									<div class="input-group">
										...
										<?php
											...
											$querynilaimtk = mysqli_query($konek, "SELECT Kode_Matakuliah_Nilai, Kode_Matakuliah, Nama_Matakuliah FROM nilai INNER JOIN Matapelajaran ON Kode_Matakuliah_nilai=Kode_Matakuliah WHERE Id_Nilai='$Id_Nilai'");
