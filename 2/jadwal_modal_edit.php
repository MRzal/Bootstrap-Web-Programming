								...
								<label>Dosen</label>
									<div class="input-group">
										...
										<?php
											...
											$queryjdwds = mysqli_query($konek, "SELECT NIP_Jadwal, NIP, Nama_Guru FROM jadwal INNER JOIN dosen ON NIP_Jadwal=NIP WHERE Id_Jadwal='$Id_Jadwal'");
											if ($queryjdwds == false){
									...
									<div class="input-group">
										...
										<select name="Kode_Jurusan_Jadwal" class="form-control">
											<?php
												...
												$queryjdwjrs = mysqli_query($konek, "SELECT Kode_Jurusan_Jadwal, Kode_Jurusan, Nama_Ekstrakurikuler FROM jadwal INNER JOIN jurusan ON Kode_Jurusan_Jadwal=Kode_Jurusan WHERE Id_Jadwal='$Id_Jadwal'");
