...
$queryjurusan = mysqli_query($konek, "SELECT * FROM Ekstrakurikuler WHERE Kode_Jurusan='$Kode_Jurusan'");
							...
							<div class="form-group">
								<label>Jurusan</label>
									<div class="input-group">
										...
										<input name="Nama_Ekstrakurikuler" type="text" class="form-control" value="<?php echo $jurusan["Nama_Ekstrakurikuler"]; ?>"/>
									</div>
							</div>
							<div class="form-group">
								<label>Jenjang</label>
									<div class="input-group">
										...
										<select name="Kode_Jenjang_Jrs" class="form-control">
											<?php
												...
												$queryjrsjnj = mysqli_query($konek, "SELECT Kode_Jenjang_Jrs, Kode_Jenjang, Nama_Jenjang FROM Ekstrakurikuler INNER JOIN jenjang ON Kode_Jenjang_Jrs = Kode_Jenjang WHERE Kode_Jurusan='$Kode_Jurusan'");
