							  ...
							  <div class="input-group">
										...
										<?php
											...
											while($dosen = mysqli_fetch_array($querydosen)){
												...
												{
													echo "<option value='$dosen[NIP]'>$dosen[Nama_Guru]</option>";
												}
											}
										?>
										</select>
									...
									<div class="input-group-addon">
										...
										<select name="Kode_Matakuliah_Jadwal" class="form-control">
											<?php
												...
												$queryjdwmk = mysqli_query($konek, "SELECT Kode_Matakuliah_Jadwal, Kode_Matakuliah, Nama_Matakuliah FROM jadwal INNER JOIN Matapelajaran ON Kode_Matakuliah_Jadwal=Kode_Matakuliah WHERE Id_Jadwal='$Id_Jadwal'");
												if($queryjdwmk == false){
													die ("Terdapat Kesalahan : ". mysqli_error($konek));
												}
									...
									<div class="input-group">
										...
										<select name="Kode_Jurusan_Jadwal" class="form-control">
											<?php
												...
												$queryjdwjrs = mysqli_query($konek, "SELECT Kode_Jurusan_Jadwal, Kode_Jurusan, Nama_Ekstrakurikuler FROM jadwal INNER JOIN Ekstrakurikuler ON Kode_Jurusan_Jadwal=Kode_Jurusan WHERE Id_Jadwal='$Id_Jadwal'");
												if($queryjdwjrs == false){
													die ("Terdapat Kesalahan : ". mysqli_error($konek));
												}
												while($jdwjrs = mysqli_fetch_array($queryjdwjrs))
												{
													echo "<option value='$jdwjrs[Kode_Jurusan_Jadwal]' selected>$jdwjrs[Nama_Ekstrakurikuler]</option>";
												}
												...
												while ($jurusan = mysqli_fetch_array($queryjurusan)){
													if($jurusan["Kode_Jurusan"] != $jadwal["Kode_Jurusan_Jadwal"]){
														echo "<option value='$jurusan[Kode_Jurusan]'>$jurusan[Nama_Ekstrakurikuler]</option>";
													}
												}
											?>
										</select>
