    ...
    <div class="wrapper">
      ...
      <li class="header"><h4><b><center style="font-size: 18px">Menu Panel</center></b></h4></li>
              <li><a href="index.php"><i class="fa fa-home"></i><span>Dashboard</span></a></li>
			        ...
			        <li class="active"><a href="jurusan.php"><i class="fa fa-university"></i><span>Ekstrakurikuler</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-university"></i> Ekstrakurikuler</li>
          </ol>
        </section>
							...
							<div class="form-group">
								<label>Kode Ekstrakurikuler</label>
									<div class="input-group">
										...
										<input name="Kode_Jurusan" type="text" class="form-control" placeholder="Kode Ekstrakurikuler"/>
									</div>
							</div>
							<div class="form-group">
								<label>Ekstrakurikuler</label>
									<div class="input-group">
										...
										<input name="Nama_Ekstrakurikuler" type="text" class="form-control" placeholder="Nama Ekstrakurikuler"/>
									</div>
							</div>
							<div class="form-group">
								<label>Jenjang</label>
